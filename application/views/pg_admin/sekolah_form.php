								...
								<form method="post" action="<?php echo $form_action?>">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<?php echo form_error('npsn', '<div class="text-danger">', '</div>'); ?>
											<input type="text" name="npsn" class="form-control" placeholder="NPSN" value="<?php echo set_value('npsn', isset($data->npsn) ? $data->npsn : '');?>" required="required" tabindex="0">
										</div>
										<div class="form-group">
									...
									<div class="col-md-offset-1 col-md-5">
										...
										<div class="form-group">
											<label>Alamat</label>
											<textarea name="alamat" class="form-control" placeholder="Alamat Sekolah" rows="5" tabindex="6"><?php echo set_value('alamat', isset($data->alamat_sekolah) ? $data->alamat_sekolah : '');?></textarea>
										</div>
										<div class="form-group">
											<label>Status<span class="text-danger">*</span></label>
											<?php echo form_error('status', '<div class="text-danger">', '</div>'); ?>
											<select data-placeholder="Pilih Status..." id="status" name="status" class="chosen-select" style="width: 100%;" tabindex="6" required="required">
												<option value="0" <?php echo set_select('status', 0, (!isset($data->status) ? FALSE : ($data->status == '0' ? TRUE : FALSE)));?>>Tidak Aktif</option>
												<option value="1" <?php echo set_select('status', 1, (!isset($data->status) ? FALSE : ($data->status == '1' ? TRUE : FALSE)));?>>Aktif</option>
											</select>
										</div>
									</div>
									</div>
