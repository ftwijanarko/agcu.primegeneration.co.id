      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                <h4 class="title"><?php echo isset($page_title) ? $page_title : "Import Data Siswa"?></h4>
              </div>
              <div class="content">
                      ...
                      <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                          <ul>
                            ...
                            <li>Kolom <strong>Nama Siswa, ID Sekolah, Kelas, ID Cabang dan Kode Aktivasi</strong> tidak boleh kosong!</li>
                            <li>Kolom <strong>ID Sekolah</strong> harus diisi sesuai dengan ID Sekolah yang ada di tabel sekolah yang terdapat di sistem</li>
                            <li>Kolom <strong>ID Cabang</strong> harus diisi sesuai dengan ID Cabang yang ada di tabel cabang yang terdapat di sistem</li>
