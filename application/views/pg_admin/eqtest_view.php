							...
							<table style="font-size:16px;">
								...
								<tr>
									<td colspan="2" style="vertical-align:middle;padding:2px 10px;">
										<?= $soal->jawab_a ? '<span style="float:left;margin-right:5px;font-size:16px;">A.</span>'.$soal->jawab_a : ''?> <?= $soal->jawab_a ? '(Skor : '.$soal->skor_a.')' : '' ?>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="vertical-align:middle;padding:2px 10px;">
										<?= $soal->jawab_b ? '<span style="float:left;margin-right:5px;font-size:16px;">B.</span>'.$soal->jawab_b : ''?> <?= $soal->jawab_b ? '(Skor : '.$soal->skor_b.')' : '' ?>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="vertical-align:middle;padding:2px 10px;">
										<?= $soal->jawab_c ? '<span style="float:left;margin-right:5px;font-size:16px;">C.</span>'.$soal->jawab_c : ''?> <?= $soal->jawab_c ? '(Skor : '.$soal->skor_c.')' : '' ?>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="vertical-align:middle;padding:2px 10px;">
										<?= $soal->jawab_d ? '<span style="float:left;margin-right:5px;font-size:16px;">D.</span>'.$soal->jawab_d : ''?> <?= $soal->jawab_d ? '(Skor : '.$soal->skor_d.')' : '' ?>
									</td>
								</tr>
							</table>							
