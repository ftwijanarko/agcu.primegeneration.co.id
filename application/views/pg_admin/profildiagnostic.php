            ...
            <div class="card">
              ...
              <div class="content">
								...
								<div class="col-md-4 col-lg-4">
									...
									<a href="diagnostictest/tambahprofil" class="btn btn-primary btn-block pull-right"><?= $this->session->userdata('idcabang') > 0 ? 'Ajukan' : 'Tambah' ?> AGCU Test</a>
								...
								<div id="containerajax">
									...
									<?php include "profildiagnostic_ajax.php"; ?>
...
foreach ($table_data as $item) 
{
	if($item->banner !== ""){
		?>
		<div class="modal fade" id="modalbanner<?php echo $item->id_profil;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
