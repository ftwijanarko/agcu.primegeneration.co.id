...
<head>
	<meta charset="utf-8" />
	<link rel="shortcut icon" href="<?=ASSETS_IMAGE.'logo-white.png'?>" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

	<title>Prime Generation Admin Dashboard</title>
  ...
  <script src="<?php echo base_url('assets/js/jquery-ui/jquery-ui.js');?>"></script>
	...
	<script type="text/javascript" src="http://primemobile.co.id/assets/js/latex_to_mathml.js"></script>
